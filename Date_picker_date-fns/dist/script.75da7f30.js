...
},{}],"node_modules/parse5/lib/tree-adapters/default.js":[function(require,module,exports) {
'use strict';
...
},{"../common/html":"node_modules/parse5/lib/common/html.js"}],"node_modules/posthtml-render/lib/index.js":[function(require,module,exports) {
...
var _default = require("parse5/lib/tree-adapters/default");
...
var datePickerBtn = document.querySelector(".date-picker-btn");
var nextMonthBtn = document.querySelector(".btn-next-month");
var previousMonthBtn = document.querySelector(".btn-previous-month");
...
datePickerBtn.addEventListener("click", function (e) {
  ...
  currentDate = selectedDate; // update calendar header
  // update alldate-grid

  renderDate(selectedDate); // Highlight selected date

  var allDateElment = _toConsumableArray(document.querySelectorAll(".date"));

  allDateElment.forEach(function (element) {
    var datetimeElement = new Date(element.dataset.date);
    element.classList.remove("selected");
    console.log(selectedDate.toISOString().split("T")[0]);

    if (datetimeElement.toISOString().split("T")[0] === selectedDate.toISOString().split("T")[0]) {
      console.log("s");
...
function renderDate(selectedDate) {
  ...
  var intervalDays = (0, _dateFns.eachDayOfInterval)({
    start: (0, _dateFns.startOfWeek)((0, _dateFns.startOfMonth)(selectedDate)),
    end: (0, _dateFns.endOfWeek)((0, _dateFns.endOfMonth)(selectedDate))
  }); // Step 3: Create element and append to date-grid

  intervalDays.forEach(function (date) {
    return createDateEl(date, selectedDate);
  });
}
...
function createDateEl(date, selectedDate) {
  ...
  if ((0, _dateFns.isSameMonth)(date, selectedDate)) {
...
function setCalendarHeader(date) {
  calendarHeader.textContent = (0, _dateFns.format)(date, "MMMM-yyyy");
}

document.addEventListener("click", function (e) {
  if (e.target.classList.contains("date-this-month") || e.target.classList.contains("date-not-this-month")) {
    setDate(new Date(e.target.dataset.date));
    calendarContainer.classList.toggle("show");
  }
});
previousMonthBtn.addEventListener("click", function () {
  var previousMonthDate = (0, _dateFns.startOfMonth)((0, _dateFns.subMonths)(currentDate, 1));
  renderDate(previousMonthDate);
  setCalendarHeader(previousMonthDate);
  currentDate = previousMonthDate;
});
nextMonthBtn.addEventListener("click", function () {
  var nextMonthDate = (0, _dateFns.startOfMonth)((0, _dateFns.addMonths)(currentDate, 1));
...
setDate(new Date());
},{"date-fns":"node_modules/date-fns/esm/index.js","parse5/lib/tree-adapters/default":"node_modules/parse5/lib/tree-adapters/default.js","posthtml-render":"node_modules/posthtml-render/lib/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
